...
// 另一条新的路由 用于处理购物车页面的加减按钮
Route::get('home/shopcart/on_off','Home\ShopcartController@on_off');
// 由于资源路由删除功能报了无法解决的bug 所以新建个路由写删除
Route::get('home/shopcart/del','Home\ShopcartController@del');
// 再次新增一条路由 用于购物车商品添加到订单结算
Route::any('home/shopcart/pay','Home\ShopcartController@pay');
...
//用户订单
// 从购物车添加到订单操作的路由 勿删
Route::get('home/orders/add','Home\UorderController@add');
Route::get('home/orders/ads','Home\UorderController@ads');
