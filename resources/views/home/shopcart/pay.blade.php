	...
	<div class="content clearfix bgf5">
		<section class="user-center inner clearfix">
			<div class="user-content__box clearfix bgf">
				...
				<form action="/home/orders/ads" class="shopcart-form__box">
					<div class="addr-radio">
						...
						<div class="radio-line radio-box active">
							<label class="radio-label ep" title="{{$ads['address'] or ''}}  {{$ads['address_info'] or ''}}  {{$ads['phone'] or ''}}">
								<input name="addr" checked value="{{$ads['id'] or ''}}" autocomplete="off" type="radio"><i class="iconfont icon-radio"></i>
					...
					<div class="shop-order__detail">
						<table class="table">
							...
							<tbody>
								<tr>
									<th scope="row" height="60"><a href="item_show.html"><div class="img"><img src="/{{$goods->goods_plot}}" alt="" class="cover"></div></a></th>
									<td>
										<div class="name ep3">{{$goods->goods_name or ''}} </div>
										<!-- <div class="type c9">颜色分类：深棕色  尺码：均码</div> -->
									</td>
									<td>￥{{$goods->goods_price or ''}}</td>
									<td>1</td>
									<td>
										@if(!empty($goods))
					...
					<div class="shop-cart__info clearfix">
						...
						<div class="pull-right text-right">
							...
							<div class="info-line"><span class="favour-value">已优惠 ¥2.0</span>合计：<b class="fz18 cr">¥{{$goods->goods_price or ''}}</b></div>
					...
					<div class="pay-mode__box">
						...
						<div class="radio-line radio-box">
							...
							<div class="pay-value">支付<b class="fz16 cr">{{$goods->goods_price or ''}}</b>元</div>
						</div>
						<div class="radio-line radio-box">
							<label class="radio-label ep">
