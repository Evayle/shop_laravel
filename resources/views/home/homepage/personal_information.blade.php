...
<!-- 个人中心 -->
            <div class="pull-right">
                <div class="user-content__box clearfix bgf">
                    ...
                    <div class="port b-r50" id="crop-avatar">
                        <div class="img"><img src="/homes/images/icons/default_avt.png" class="cover b-r50"></div>
                    </div>
    ...
    <!-- 头像选择模态框 -->
    <link href="/homes/css/cropper/cropper.min.css" rel="stylesheet">
    <link href="/homes/css/cropper/sitelogo.css" rel="stylesheet">
    <script src="/homes/js/cropper/cropper.min.js"></script>
    <script src="/homes/js/cropper/sitelogo.js"></script>
