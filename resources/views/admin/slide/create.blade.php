...
<section class="wrapper">
	...
	{{ csrf_field() }}
	  <div class="form-group">
	    ...
	    <div class="col-sm-8">
	      <input type="text" class="form-control" placeholder="填写图片名字" name="slide_name">
	    </div>
	  </div>
	  <div class="form-group">
	    <label for="inputEmail3" class="col-sm-2 control-label"><span class="user_add">详　细　描　述</span></label>
	    <div class="col-sm-offset-2 col-sm-10">
	      <textarea name="slide_note" id="" cols="50" rows="6" placeholder="填写图片的详细描述(不超过255个字)"></textarea>
	    </div>
	  </div>
	  <div class="form-group">
